...
cnf(goal_1, negated_conjecture, (product(domain(X0),domain(X0),domain(domain(X0))))).
...
cnf(goal_6, negated_conjecture, (identity_map(domain(domain(X0))))).
cnf(goal_7, negated_conjecture, (product(domain(X0),domain(domain(X0)),domain(X0)))).
