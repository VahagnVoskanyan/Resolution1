...
cnf(goal_1, negated_conjecture, (~product(X0,X2,X0))).
cnf(goal_2, negated_conjecture, (product(X2,X2,X2))).
cnf(goal_3, negated_conjecture, (identity_map(X2))).
cnf(goal_4, negated_conjecture, (product(X2,X2,X4))).
cnf(goal_5, negated_conjecture, (product(X0,X2,X2))).
cnf(goal_6, negated_conjecture, (product(X2,X4,X2))).
cnf(goal_7, negated_conjecture, (defined(X2,X4))).
