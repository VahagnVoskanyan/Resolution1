...
cnf(goal_1, negated_conjecture, (domain(X0) = codomain(domain(X0)))).
cnf(goal_2, negated_conjecture, (~equivalent(domain(X0),domain(X0)))).
cnf(goal_3, negated_conjecture, (domain(X0) = codomain(X1))).
cnf(goal_4, negated_conjecture, (there_exists(compose(X0,X1)))).
