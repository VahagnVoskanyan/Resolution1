...
cnf(goal_1, negated_conjecture, (product(X0,X4,codomain(X0)))).
cnf(goal_2, negated_conjecture, (product(X0,X0,codomain(X0)))).
cnf(goal_3, negated_conjecture, (product(X0,X0,X4))).
...
cnf(goal_7, negated_conjecture, (identity_map(X1))).
cnf(goal_8, negated_conjecture, (product(X1,X0,X4))).
cnf(goal_9, negated_conjecture, (identity_map(X0))).
cnf(goal_10, negated_conjecture, (product(X0,X4,X0))).
