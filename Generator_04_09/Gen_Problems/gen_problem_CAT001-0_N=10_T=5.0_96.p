...
cnf(goal_1, negated_conjecture, (defined(domain(X4),domain(X4)))).
cnf(goal_2, negated_conjecture, (product(X1,X2,X4))).
cnf(goal_3, negated_conjecture, (product(X3,X2,domain(X4)))).
cnf(goal_4, negated_conjecture, (identity_map(domain(X4)))).
cnf(goal_5, negated_conjecture, (product(X4,X1,X3))).
cnf(goal_6, negated_conjecture, (~product(domain(X4),domain(X4),domain(X4)))).
cnf(goal_7, negated_conjecture, (product(domain(X4),domain(X4),domain(X4)))).
