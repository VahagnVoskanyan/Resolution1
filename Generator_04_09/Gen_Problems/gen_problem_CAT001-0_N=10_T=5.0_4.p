...
cnf(goal_1, negated_conjecture, (product(X4,X2,codomain(X4)))).
cnf(goal_2, negated_conjecture, (product(X4,X4,codomain(X4)))).
cnf(goal_3, negated_conjecture, (product(X5,X2,domain(X4)))).
cnf(goal_4, negated_conjecture, (codomain(X4) != X4)).
cnf(goal_5, negated_conjecture, (product(X4,X1,X5))).
cnf(goal_6, negated_conjecture, (product(X5,X2,X5))).
cnf(goal_7, negated_conjecture, (defined(codomain(X4),codomain(X4)))).
cnf(goal_8, negated_conjecture, (product(X1,X2,X4))).
cnf(goal_9, negated_conjecture, (product(codomain(X4),codomain(X4),codomain(X4)))).
