...
cnf(goal_1, negated_conjecture, (product(X5,domain(X5),X5))).
cnf(goal_2, negated_conjecture, (product(X5,X5,X5))).
cnf(goal_3, negated_conjecture, (~product(X5,domain(domain(X5)),X5))).
cnf(goal_4, negated_conjecture, (product(X5,domain(domain(X5)),X5))).
