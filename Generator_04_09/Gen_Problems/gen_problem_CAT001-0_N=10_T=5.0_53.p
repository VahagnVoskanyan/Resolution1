...
cnf(goal_1, negated_conjecture, (product(X3,X4,X2))).
cnf(goal_2, negated_conjecture, (product(X2,domain(X2),domain(X2)))).
cnf(goal_3, negated_conjecture, (product(X2,X2,domain(domain(X2))))).
cnf(goal_4, negated_conjecture, (defined(X2,X2))).
cnf(goal_5, negated_conjecture, (product(X3,X3,X3))).
cnf(goal_6, negated_conjecture, (product(X3,X2,domain(X2)))).
cnf(goal_7, negated_conjecture, (~product(domain(X2),domain(X2),compose(X0,X1)))).
cnf(goal_8, negated_conjecture, (product(X3,X2,X2))).
cnf(goal_9, negated_conjecture, (identity_map(domain(X2)))).
cnf(goal_10, negated_conjecture, (product(X3,X1,X3))).
cnf(goal_11, negated_conjecture, (product(X1,X2,X4))).
cnf(goal_12, negated_conjecture, (product(X2,X3,X3))).
