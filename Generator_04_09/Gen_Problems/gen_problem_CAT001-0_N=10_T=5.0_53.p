...
cnf(goal_4, negated_conjecture, (product(domain(X0),X3,domain(X0)))).
cnf(goal_5, negated_conjecture, (product(domain(X0),codomain(domain(X0)),codomain(domain(X0))))).
cnf(goal_6, negated_conjecture, (product(X0,X3,X3))).
