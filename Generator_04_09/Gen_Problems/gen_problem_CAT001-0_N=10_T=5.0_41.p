...
cnf(goal_1, negated_conjecture, (product(codomain(X0),codomain(X0),X0))).
cnf(goal_2, negated_conjecture, (product(X4,X4,X4))).
cnf(goal_3, negated_conjecture, (product(X4,codomain(X0),X4))).
cnf(goal_4, negated_conjecture, (identity_map(X4))).
cnf(goal_5, negated_conjecture, (product(X0,codomain(X0),codomain(X0)))).
cnf(goal_6, negated_conjecture, (product(codomain(X0),codomain(X0),codomain(X0)))).
cnf(goal_7, negated_conjecture, (~defined(codomain(X0),X0))).
cnf(goal_8, negated_conjecture, (product(X4,X4,codomain(X0)))).
cnf(goal_9, negated_conjecture, (identity_map(codomain(X0)))).
cnf(goal_10, negated_conjecture, (defined(X4,X4))).
