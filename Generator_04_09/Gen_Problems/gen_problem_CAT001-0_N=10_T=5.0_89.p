...
cnf(goal_1, negated_conjecture, (X3 != X3)).
cnf(goal_2, negated_conjecture, (defined(X3,X4))).
cnf(goal_3, negated_conjecture, (product(domain(X3),codomain(X3),domain(X3)))).
cnf(goal_4, negated_conjecture, (identity_map(X3))).
cnf(goal_5, negated_conjecture, (product(X1,domain(X3),X4))).
cnf(goal_6, negated_conjecture, (identity_map(codomain(X3)))).
cnf(goal_7, negated_conjecture, (product(X3,X1,X3))).
cnf(goal_8, negated_conjecture, (product(X3,domain(X3),domain(X3)))).
