...
cnf(goal_3, negated_conjecture, (product(X0,domain(X0),X3))).
cnf(goal_4, negated_conjecture, (product(domain(X0),domain(X0),X4))).
cnf(goal_5, negated_conjecture, (defined(X3,codomain(domain(X0))))).
cnf(goal_6, negated_conjecture, (~product(codomain(domain(X0)),codomain(domain(X0)),compose(X0,X1)))).
cnf(goal_7, negated_conjecture, (product(X0,domain(X0),domain(X0)))).
cnf(goal_8, negated_conjecture, (product(codomain(domain(X0)),codomain(domain(X0)),domain(X0)))).
cnf(goal_9, negated_conjecture, (product(domain(X0),domain(X0),codomain(domain(X0))))).
