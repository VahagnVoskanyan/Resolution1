...
cnf(goal_1, negated_conjecture, (product(X1,X0,X0))).
cnf(goal_2, negated_conjecture, (product(X0,X1,codomain(X0)))).
cnf(goal_3, negated_conjecture, (product(codomain(X0),domain(X1),domain(X1)))).
cnf(goal_4, negated_conjecture, (identity_map(X1))).
cnf(goal_5, negated_conjecture, (X1 != X1)).
cnf(goal_6, negated_conjecture, (product(X1,X1,codomain(X0)))).
