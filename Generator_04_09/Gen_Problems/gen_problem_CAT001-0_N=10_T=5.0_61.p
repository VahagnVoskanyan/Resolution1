...
cnf(goal_2, negated_conjecture, (defined(domain(X0),domain(X0)))).
cnf(goal_3, negated_conjecture, (product(X4,X1,X4))).
cnf(goal_4, negated_conjecture, (identity_map(X1))).
cnf(goal_5, negated_conjecture, (defined(X0,X1))).
cnf(goal_6, negated_conjecture, (product(X0,X4,X0))).
cnf(goal_7, negated_conjecture, (product(X4,domain(X0),X4))).
cnf(goal_8, negated_conjecture, (product(domain(X0),X4,X0))).
cnf(goal_9, negated_conjecture, (product(X4,X4,X4))).
cnf(goal_10, negated_conjecture, (~defined(X0,X4))).
