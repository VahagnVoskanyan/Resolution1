...
cnf(goal_1, negated_conjecture, (identity_map(codomain(X3)))).
cnf(goal_2, negated_conjecture, (product(X3,X3,domain(X3)))).
cnf(goal_3, negated_conjecture, (identity_map(domain(X3)))).
cnf(goal_4, negated_conjecture, (product(X3,codomain(X3),X3))).
cnf(goal_5, negated_conjecture, (product(X3,codomain(X3),codomain(X3)))).
cnf(goal_6, negated_conjecture, (product(codomain(X3),codomain(X3),X6))).
cnf(goal_7, negated_conjecture, (codomain(X3) != X6)).
