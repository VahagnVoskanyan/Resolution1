...
cnf(goal_1, negated_conjecture, (defined(X3,X5))).
cnf(goal_2, negated_conjecture, (identity_map(X3))).
cnf(goal_3, negated_conjecture, (domain(X3) != domain(X3))).
cnf(goal_4, negated_conjecture, (product(X5,X5,X4))).
cnf(goal_5, negated_conjecture, (product(X3,X5,X3))).
cnf(goal_6, negated_conjecture, (product(X3,X4,X5))).
cnf(goal_7, negated_conjecture, (identity_map(X5))).
cnf(goal_8, negated_conjecture, (product(X5,X5,domain(X3)))).
cnf(goal_9, negated_conjecture, (defined(domain(X3),domain(X3)))).
