...
cnf(goal_2, negated_conjecture, (product(X1,codomain(X0),X4))).
cnf(goal_3, negated_conjecture, (product(X0,X1,codomain(X0)))).
cnf(goal_4, negated_conjecture, (identity_map(codomain(X0)))).
cnf(goal_5, negated_conjecture, (product(codomain(X0),codomain(codomain(X0)),codomain(X0)))).
cnf(goal_6, negated_conjecture, (product(codomain(X0),codomain(X0),codomain(codomain(X0))))).
cnf(goal_7, negated_conjecture, (defined(X0,codomain(X0)))).
cnf(goal_8, negated_conjecture, (product(X0,X4,X0))).
