...
cnf(goal_2, negated_conjecture, (product(domain(X5),X1,X3))).
cnf(goal_3, negated_conjecture, (~defined(X5,X5))).
cnf(goal_4, negated_conjecture, (product(X1,X5,X5))).
cnf(goal_5, negated_conjecture, (product(X3,X5,X5))).
cnf(goal_6, negated_conjecture, (identity_map(X5))).
cnf(goal_7, negated_conjecture, (defined(X5,X5))).
