...
cnf(goal_1, negated_conjecture, (product(X2,X2,X2))).
cnf(goal_2, negated_conjecture, (product(X2,X4,domain(X2)))).
cnf(goal_3, negated_conjecture, (product(X2,X1,X2))).
cnf(goal_4, negated_conjecture, (product(X1,X2,X4))).
cnf(goal_5, negated_conjecture, (X2 != X2)).
