...
cnf(goal_1, negated_conjecture, (product(X0,X1,domain(X0)))).
...
cnf(goal_6, negated_conjecture, (product(X1,domain(X0),domain(X0)))).
cnf(goal_7, negated_conjecture, (defined(X0,domain(X0)))).
cnf(goal_8, negated_conjecture, (product(X0,X0,domain(X0)))).
