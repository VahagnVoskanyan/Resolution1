...
cnf(goal_1, negated_conjecture, (f1(X0, X0) = X0)).
cnf(goal_2, negated_conjecture, (X0 != X0)).
cnf(goal_3, negated_conjecture, (equivalent(f1(f1(X1,X1),X1),X0))).
cnf(goal_4, negated_conjecture, (f1(f1(X1, X1), X0) = f1(X0, X0))).
