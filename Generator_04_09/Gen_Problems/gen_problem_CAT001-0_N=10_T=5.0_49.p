...
cnf(goal_3, negated_conjecture, (identity_map(codomain(X0)))).
cnf(goal_4, negated_conjecture, (product(codomain(X0),X0,codomain(X0)))).
cnf(goal_5, negated_conjecture, (~defined(X0,X2))).
cnf(goal_6, negated_conjecture, (product(X0,X2,codomain(X0)))).
