...
cnf(goal_2, negated_conjecture, (product(X2,domain(X2),X2))).
cnf(goal_3, negated_conjecture, (product(X2,X2,X2))).
cnf(goal_4, negated_conjecture, (product(X2,X4,domain(X2)))).
cnf(goal_5, negated_conjecture, (product(X1,X2,X4))).
cnf(goal_6, negated_conjecture, (identity_map(X2))).
cnf(goal_7, negated_conjecture, (product(X2,X1,X2))).
