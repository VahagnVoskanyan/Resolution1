...
cnf(goal_1, negated_conjecture, (product(X3,X0,domain(domain(X3))))).
cnf(goal_2, negated_conjecture, (product(X3,domain(domain(X3)),domain(X3)))).
cnf(goal_3, negated_conjecture, (identity_map(X0))).
cnf(goal_4, negated_conjecture, (product(X0,X2,X0))).
cnf(goal_5, negated_conjecture, (product(X3,X3,domain(X3)))).
cnf(goal_6, negated_conjecture, (product(X3,X3,X3))).
cnf(goal_7, negated_conjecture, (defined(X0,X0))).
cnf(goal_8, negated_conjecture, (~product(domain(X3),domain(X3),domain(X3)))).
cnf(goal_9, negated_conjecture, (product(X3,X0,X3))).
cnf(goal_10, negated_conjecture, (defined(domain(X3),domain(X3)))).
