...
cnf(goal_1, negated_conjecture, (product(X5,codomain(X5),X5))).
cnf(goal_2, negated_conjecture, (defined(X5,codomain(X5)))).
cnf(goal_3, negated_conjecture, (product(X5,X5,domain(X5)))).
cnf(goal_4, negated_conjecture, (product(domain(X5),X5,X5))).
cnf(goal_5, negated_conjecture, (X5 != X5)).
cnf(goal_6, negated_conjecture, (product(domain(X5),codomain(X5),X5))).
cnf(goal_7, negated_conjecture, (product(domain(X5),codomain(X5),codomain(X5)))).
