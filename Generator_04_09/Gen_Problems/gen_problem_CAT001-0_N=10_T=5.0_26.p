...
cnf(goal_2, negated_conjecture, (product(domain(X0),X2,X4))).
cnf(goal_3, negated_conjecture, (~product(domain(X0),X2,X5))).
cnf(goal_4, negated_conjecture, (identity_map(domain(X0)))).
cnf(goal_5, negated_conjecture, (identity_map(X0))).
