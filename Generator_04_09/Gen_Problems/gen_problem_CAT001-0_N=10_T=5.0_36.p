...
cnf(goal_1, negated_conjecture, (defined(X5,X2))).
cnf(goal_2, negated_conjecture, (product(X5,X4,X5))).
cnf(goal_3, negated_conjecture, (product(X2,X2,X2))).
cnf(goal_4, negated_conjecture, (X2 != X2)).
cnf(goal_5, negated_conjecture, (defined(X2,codomain(X2)))).
...
cnf(goal_9, negated_conjecture, (defined(X5,domain(X0)))).
