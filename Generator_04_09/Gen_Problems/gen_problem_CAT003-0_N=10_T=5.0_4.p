...
cnf(goal_1, negated_conjecture, (domain(X0) = codomain(X1))).
cnf(goal_2, negated_conjecture, (there_exists(domain(X0)))).
cnf(goal_3, negated_conjecture, (equivalent(domain(X0),domain(domain(X0))))).
cnf(goal_4, negated_conjecture, (equivalent(X0,domain(X0)))).
cnf(goal_5, negated_conjecture, (domain(X0) != domain(X0))).
