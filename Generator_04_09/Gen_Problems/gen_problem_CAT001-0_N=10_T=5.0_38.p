...
cnf(goal_1, negated_conjecture, (product(X0,X1,X3))).
cnf(goal_2, negated_conjecture, (X0 != X0)).
cnf(goal_3, negated_conjecture, (product(X1,X1,domain(X0)))).
cnf(goal_4, negated_conjecture, (product(X0,X1,X0))).
cnf(goal_5, negated_conjecture, (product(X1,X1,X0))).
cnf(goal_6, negated_conjecture, (identity_map(X1))).
cnf(goal_7, negated_conjecture, (defined(X0,X1))).
cnf(goal_8, negated_conjecture, (defined(X3,X1))).
cnf(goal_9, negated_conjecture, (defined(X1,domain(X0)))).
cnf(goal_10, negated_conjecture, (identity_map(domain(X0)))).
cnf(goal_11, negated_conjecture, (product(domain(X0),X0,domain(X0)))).
