...
cnf(goal_1, negated_conjecture, (product(domain(X0),domain(X0),X3))).
cnf(goal_2, negated_conjecture, (identity_map(codomain(domain(X0))))).
...
cnf(goal_6, negated_conjecture, (product(domain(X0),X2,domain(X0)))).
cnf(goal_7, negated_conjecture, (product(X2,codomain(domain(X0)),domain(X0)))).
cnf(goal_8, negated_conjecture, (codomain(domain(X0)) != domain(X0))).
cnf(goal_9, negated_conjecture, (product(X2,X2,domain(X0)))).
