...
cnf(goal_1, negated_conjecture, (~equivalent(X1,X1))).
cnf(goal_2, negated_conjecture, (domain(domain(domain(X1))) = codomain(X1))).
cnf(goal_3, negated_conjecture, (domain(X1) = codomain(X1))).
cnf(goal_4, negated_conjecture, (there_exists(domain(domain(domain(domain(X1))))))).
cnf(goal_5, negated_conjecture, (there_exists(compose(X0,X1)))).
