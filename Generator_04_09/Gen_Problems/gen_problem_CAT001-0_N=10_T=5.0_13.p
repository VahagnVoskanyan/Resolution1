...
cnf(goal_3, negated_conjecture, (product(X0,X0,domain(X0)))).
cnf(goal_4, negated_conjecture, (product(domain(X0),X2,codomain(X0)))).
cnf(goal_5, negated_conjecture, (X0 != X0)).
cnf(goal_6, negated_conjecture, (identity_map(X0))).
cnf(goal_7, negated_conjecture, (product(domain(X0),X0,domain(X0)))).
cnf(goal_8, negated_conjecture, (product(X0,X2,X0))).
