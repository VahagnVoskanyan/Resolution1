...
cnf(goal_3, negated_conjecture, (product(X2,X2,domain(X2)))).
...
cnf(goal_7, negated_conjecture, (product(domain(X2),X2,domain(X2)))).
cnf(goal_8, negated_conjecture, (defined(X2,X1))).
