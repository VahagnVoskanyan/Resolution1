...
cnf(goal_1, negated_conjecture, (product(X3,X4,codomain(X0)))).
...
cnf(goal_5, negated_conjecture, (product(X0,X4,X4))).
cnf(goal_6, negated_conjecture, (defined(X3,X4))).
cnf(goal_7, negated_conjecture, (identity_map(X0))).
cnf(goal_8, negated_conjecture, (defined(codomain(X0),X0))).
cnf(goal_9, negated_conjecture, (product(X0,X0,X3))).
cnf(goal_10, negated_conjecture, (~defined(X0,codomain(X0)))).
