...
cnf(goal_1, negated_conjecture, (defined(X3,domain(X0)))).
cnf(goal_2, negated_conjecture, (product(domain(X0),domain(X0),domain(X0)))).
cnf(goal_3, negated_conjecture, (defined(domain(X0),domain(X0)))).
cnf(goal_4, negated_conjecture, (product(domain(domain(X0)),domain(domain(X0)),domain(X0)))).
cnf(goal_5, negated_conjecture, (product(X0,domain(X0),X3))).
cnf(goal_6, negated_conjecture, (defined(domain(domain(X0)),domain(domain(domain(X0)))))).
cnf(goal_7, negated_conjecture, (product(domain(X0),domain(X0),domain(domain(domain(X0)))))).
cnf(goal_8, negated_conjecture, (product(domain(domain(X0)),domain(domain(X0)),domain(domain(X0))))).
cnf(goal_9, negated_conjecture, (~defined(X0,domain(X0)))).
