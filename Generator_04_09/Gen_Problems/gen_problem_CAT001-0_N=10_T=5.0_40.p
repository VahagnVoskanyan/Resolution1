...
cnf(goal_1, negated_conjecture, (defined(X0,domain(X4)))).
cnf(goal_2, negated_conjecture, (identity_map(domain(X4)))).
cnf(goal_3, negated_conjecture, (defined(domain(domain(X4)),domain(X4)))).
cnf(goal_4, negated_conjecture, (identity_map(domain(domain(X4))))).
cnf(goal_5, negated_conjecture, (product(X4,X4,domain(X4)))).
cnf(goal_6, negated_conjecture, (~defined(X0,domain(X4)))).
cnf(goal_7, negated_conjecture, (product(X4,X4,domain(domain(X4))))).
