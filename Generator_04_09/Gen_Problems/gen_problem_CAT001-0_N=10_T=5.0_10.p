...
cnf(goal_1, negated_conjecture, (defined(codomain(X1),codomain(X1)))).
cnf(goal_2, negated_conjecture, (defined(X3,codomain(X1)))).
cnf(goal_3, negated_conjecture, (product(X1,codomain(X1),codomain(X1)))).
cnf(goal_4, negated_conjecture, (identity_map(codomain(X1)))).
cnf(goal_5, negated_conjecture, (product(X1,X1,X3))).
cnf(goal_6, negated_conjecture, (product(codomain(X1),codomain(X1),codomain(X1)))).
cnf(goal_7, negated_conjecture, (~product(X1,codomain(X1),compose(X0,X1)))).
