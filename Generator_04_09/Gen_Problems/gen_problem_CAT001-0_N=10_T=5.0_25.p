...
cnf(goal_1, negated_conjecture, (product(X0,X1,X5))).
cnf(goal_2, negated_conjecture, (product(X0,X4,X5))).
cnf(goal_3, negated_conjecture, (product(X1,X5,X4))).
cnf(goal_4, negated_conjecture, (identity_map(X5))).
