...
cnf(goal_1, negated_conjecture, (~product(X1,X1,X1))).
cnf(goal_2, negated_conjecture, (defined(X1,X1))).
cnf(goal_3, negated_conjecture, (identity_map(X1))).
cnf(goal_4, negated_conjecture, (product(X1,X1,codomain(X1)))).
cnf(goal_5, negated_conjecture, (product(X1,X1,X1))).
