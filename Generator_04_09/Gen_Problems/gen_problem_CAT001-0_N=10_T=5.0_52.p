...
cnf(goal_3, negated_conjecture, (defined(X0,codomain(X0)))).
cnf(goal_4, negated_conjecture, (product(X0,codomain(X0),X0))).
...
cnf(goal_8, negated_conjecture, (~defined(X0,codomain(X0)))).
cnf(goal_9, negated_conjecture, (identity_map(codomain(X0)))).
cnf(goal_10, negated_conjecture, (product(X0,X0,codomain(X0)))).
