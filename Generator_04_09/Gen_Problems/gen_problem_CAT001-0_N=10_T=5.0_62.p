...
cnf(goal_1, negated_conjecture, (product(codomain(codomain(X0)),X0,X3))).
cnf(goal_2, negated_conjecture, (defined(codomain(codomain(X0)),codomain(codomain(X0))))).
cnf(goal_3, negated_conjecture, (product(X0,codomain(X0),X3))).
cnf(goal_4, negated_conjecture, (product(X0,X0,X3))).
cnf(goal_5, negated_conjecture, (defined(X3,X2))).
cnf(goal_6, negated_conjecture, (product(X0,X2,codomain(codomain(codomain(X0)))))).
cnf(goal_7, negated_conjecture, (identity_map(codomain(codomain(X0))))).
cnf(goal_8, negated_conjecture, (product(codomain(X0),X2,codomain(X0)))).
cnf(goal_9, negated_conjecture, (product(codomain(X0),codomain(codomain(X0)),codomain(codomain(X0))))).
cnf(goal_10, negated_conjecture, (product(codomain(codomain(codomain(X0))),codomain(codomain(codomain(X0))),codomain(codomain(codomain(X0)))))).
cnf(goal_11, negated_conjecture, (product(codomain(codomain(X0)),codomain(codomain(codomain(X0))),codomain(codomain(X0))))).
cnf(goal_12, negated_conjecture, (~product(X0,codomain(X0),X0))).
cnf(goal_13, negated_conjecture, (defined(X3,codomain(codomain(X0))))).
