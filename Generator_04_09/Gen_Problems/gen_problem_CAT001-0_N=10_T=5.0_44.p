...
cnf(goal_1, negated_conjecture, (product(X3,X3,X3))).
cnf(goal_2, negated_conjecture, (~defined(X0,X4))).
cnf(goal_3, negated_conjecture, (product(codomain(X3),X3,codomain(X3)))).
cnf(goal_4, negated_conjecture, (defined(X3,codomain(X3)))).
cnf(goal_5, negated_conjecture, (product(X3,codomain(X3),X4))).
