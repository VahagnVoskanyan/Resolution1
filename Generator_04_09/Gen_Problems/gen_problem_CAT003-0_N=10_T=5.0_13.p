...
cnf(goal_1, negated_conjecture, (equivalent(X0,domain(domain(X0))))).
cnf(goal_2, negated_conjecture, (there_exists(domain(domain(X0))))).
cnf(goal_3, negated_conjecture, (domain(X0) = codomain(domain(X0)))).
cnf(goal_4, negated_conjecture, (~equivalent(codomain(X0),codomain(X0)))).
