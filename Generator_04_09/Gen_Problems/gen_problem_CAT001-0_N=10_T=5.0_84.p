...
cnf(goal_2, negated_conjecture, (product(X0,codomain(domain(X0)),domain(X0)))).
cnf(goal_3, negated_conjecture, (defined(X0,codomain(domain(X0))))).
cnf(goal_4, negated_conjecture, (X0 != X0)).
