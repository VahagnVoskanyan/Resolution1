...
cnf(goal_2, negated_conjecture, (product(codomain(X0),codomain(X0),codomain(X0)))).
cnf(goal_3, negated_conjecture, (~defined(codomain(X0),X0))).
cnf(goal_4, negated_conjecture, (defined(codomain(X0),X0))).
