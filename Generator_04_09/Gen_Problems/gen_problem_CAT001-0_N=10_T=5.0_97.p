...
cnf(goal_1, negated_conjecture, (product(X2,codomain(X2),domain(X2)))).
cnf(goal_2, negated_conjecture, (product(X2,X2,codomain(X0)))).
cnf(goal_3, negated_conjecture, (product(X2,codomain(X2),X0))).
cnf(goal_4, negated_conjecture, (identity_map(X2))).
cnf(goal_5, negated_conjecture, (product(X2,X2,X4))).
cnf(goal_6, negated_conjecture, (product(X0,X2,X2))).
