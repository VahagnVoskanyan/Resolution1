...
cnf(goal_1, negated_conjecture, (product(domain(X1),X2,X2))).
cnf(goal_2, negated_conjecture, (product(X1,X1,X3))).
cnf(goal_3, negated_conjecture, (~product(domain(X1),domain(X1),compose(X0,X1)))).
cnf(goal_4, negated_conjecture, (product(X1,domain(X1),X1))).
