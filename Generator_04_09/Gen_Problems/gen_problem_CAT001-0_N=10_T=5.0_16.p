...
cnf(goal_1, negated_conjecture, (~product(domain(X0),domain(domain(X0)),compose(X0,X1)))).
cnf(goal_2, negated_conjecture, (product(domain(X0),domain(X0),domain(X0)))).
cnf(goal_3, negated_conjecture, (product(X0,X0,X0))).
cnf(goal_4, negated_conjecture, (identity_map(X0))).
cnf(goal_5, negated_conjecture, (product(domain(X0),domain(X0),domain(domain(X0))))).
cnf(goal_6, negated_conjecture, (product(X0,domain(X0),domain(X0)))).
