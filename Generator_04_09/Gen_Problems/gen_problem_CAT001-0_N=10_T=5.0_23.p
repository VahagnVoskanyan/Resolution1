...
cnf(goal_4, negated_conjecture, (product(codomain(X0),X0,X0))).
cnf(goal_5, negated_conjecture, (product(X0,X2,X4))).
cnf(goal_6, negated_conjecture, (product(X0,X0,X4))).
cnf(goal_7, negated_conjecture, (product(X0,X0,codomain(X0)))).
