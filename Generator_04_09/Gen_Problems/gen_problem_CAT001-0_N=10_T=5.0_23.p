...
cnf(goal_1, negated_conjecture, (~defined(X3,X3))).
cnf(goal_2, negated_conjecture, (defined(X3,X2))).
cnf(goal_3, negated_conjecture, (defined(X3,X3))).
cnf(goal_4, negated_conjecture, (product(domain(X3),X3,X2))).
cnf(goal_5, negated_conjecture, (product(X3,X3,X3))).
cnf(goal_6, negated_conjecture, (identity_map(X3))).
