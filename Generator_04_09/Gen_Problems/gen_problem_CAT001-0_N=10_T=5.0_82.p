...
cnf(goal_4, negated_conjecture, (product(domain(codomain(X0)),codomain(X0),codomain(X0)))).
cnf(goal_5, negated_conjecture, (product(domain(codomain(X0)),domain(codomain(X0)),codomain(X0)))).
cnf(goal_6, negated_conjecture, (~product(X0,codomain(X0),X5))).
cnf(goal_7, negated_conjecture, (product(X3,codomain(X0),X5))).
