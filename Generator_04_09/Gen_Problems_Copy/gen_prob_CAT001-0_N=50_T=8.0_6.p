...
cnf(goal_1, negated_conjecture, (defined(X4,X2))).
cnf(goal_2, negated_conjecture, (defined(X4,domain(X4)))).
cnf(goal_3, negated_conjecture, (product(X4,domain(X4),X4))).
cnf(goal_4, negated_conjecture, (product(X0,X4,X4))).
cnf(goal_5, negated_conjecture, (product(X1,domain(X4),X4))).
cnf(goal_6, negated_conjecture, (product(X4,X4,X2))).
cnf(goal_7, negated_conjecture, (identity_map(domain(X4)))).
cnf(goal_8, negated_conjecture, (product(X4,X2,X4))).
cnf(goal_9, negated_conjecture, (product(X4,X1,X4))).
cnf(goal_10, negated_conjecture, (~product(X4,X4,compose(X0,X1)))).
cnf(goal_11, negated_conjecture, (product(X1,X2,X4))).
cnf(goal_12, negated_conjecture, (defined(X4,X4))).
cnf(goal_13, negated_conjecture, (product(X4,X4,X4))).
cnf(goal_14, negated_conjecture, (defined(X0,X4))).
