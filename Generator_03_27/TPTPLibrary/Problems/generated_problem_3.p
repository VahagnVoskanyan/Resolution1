...
fof(conjecture, conjecture, ((~(fof(c, X)) | (accept_leader(Z, b) => accept_team(c, a))) & ((any_agent_in_all_proposed_teams(a, X) & accept_population(b, Z)) | (accept_city(X, Y) => any_agent_in_all_proposed_teams(b, a))))).